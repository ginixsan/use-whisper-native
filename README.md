...
Repository: [https://github.com/ginixsan/use-whisper-native](https://github.com/ginixsan/use-whisper-native)

Progress: [https://github.com/ginixsan/use-whisper-native/issues/1](https://github.com/ginixnsan/use-whisper-native/issues/1)

- ### Install

```
npm i @ginixsan/use-whisper
```

```
yarn add @ginixsan/use-whisper
```

- ### Usage

```jsx
import { useWhisper } from '@ginixsan/use-whisper'
...
- ### Dependencies
  ...
  - **@ginixsan/react-hooks-async** asynchronous react hooks
...
[https://ginixsan.github.io](https://ginixsan.github.io)
